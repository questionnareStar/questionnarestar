...
<script>
import VotingBlank from "../components/questions/BlankQuestion.vue";
import VotingMark from "../components/questions/MarkQuestion.vue";
...
export default {
  ...
  methods: {
    ...
    submit() {
      survey
        .submitSurvey(this.$route.params.id, this.answers)
        .then((response) => {
          console.log(response);
