        ...
        <div class="col-md-4">
            <div class="ml-10 panel">
                <div class="shadow p-5 mb-20">
                    ...
                    <el-row class="mb-8">
                        <el-switch v-model="setLimit" @change="changeMaxnum()" active-text="填写次数限制" />
                    </el-row>
                    <el-row class="mb-8" v-if="setLimit">
                        <el-input v-model="Limitnum" placeholder="请输入限制次数"></el-input>
                    </el-row>
...
export default {
    ...
    mounted() {
        ...
        this.data.questions.push(q1);
        this.data.questions.push(q2);
